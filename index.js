...
//     var minuteLivedtext = "you have lived " + minutesyoulived + " minutes"; 
//      //minuteLived.textContent = "you have lived " + minutesyoulived + " minutes"; 

//     var card = document.createElement('card');
//     card.classList.add("card-panel");
//     card.append(minuteLivedtext);

//     document.querySelector(".minutes-div").appendChild(card);
...
//          span.textContent = zodiac[0];
//          card.append(span);
//          zodiacv.appendChild(card);
//    }
